...
private fun translateSource(source: Int): String {
    return when (source) {
...
private fun translateType(type: Int): String {
    return when (type) {
...
private fun translateSeverity(severity: Int): String {
...
private fun openGlDebugMessageCallback(
    source: GLenum,
    type: GLenum,
    id: GLuint,
    severity: GLenum,
...
fun glEnableDebug(synchronous: Boolean = true) {
    ...
    glDebugMessageCallback(staticCFunction(::openGlDebugMessageCallback), null)
